...
from custom_types import RAGQuerResult, RAGSearchResult, RAGUpserResult, RAGChunkAndSrc
...
async def rag_ingest_pdf(ctx: inngest.Context):
    ...
    async def _upsert(chunks_and_src: RAGChunkAndSrc) -> RAGUpserResult:
...
async def rag_query_pdf_ai(ctx: inngest.Context):
    ...
    return {"answer": answer, "sources": found.source, "num_contexts": len(found.context)}
